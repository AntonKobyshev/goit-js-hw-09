...
function onStartTimer() {
    ...
    Object.entries(deltaTime).forEach(([key, value], index)=>{
        [
            ...refs.timerValueEls
        ][index].textContent = addLeadingZero(value);
    });
}
(0, _flatpickrDefault.default)(refs.calendarEl, {
    enableTime: true,
    time_24hr: true,
...
function notifyFailure() {
    (0, _notiflixNotifyAio.Notify).failure("Please choose a date in the furute", {
        timeout: 2000,
        clickToClose: true,
        pauseOnHover: false,
